...
export default function RegisterScreen() {
  ...
  const handleRegister = async () => {
    ...
    if (password.length < 6) { setError(i18n.t("auth.error.passwordTooShort")); return; }
    setLoading(true);
    setError("");
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.flex}>
        ...
        >
          <View style={styles.logoArea}>
            ...
            <Text style={styles.tagline}>{i18n.t("auth.createAccount")}</Text>
          </View>
          ...
          <View style={styles.card}>
            ...
            >
              <Text style={styles.primaryBtnText}>
                {loading ? i18n.t("auth.signingUp") : i18n.t("auth.signUp")}
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.footer}>
            ...
            <Pressable onPress={() => router.replace("/(auth)/login")}>
              <Text style={styles.footerLink}>{i18n.t("auth.signIn")}</Text>
            </Pressable>
          </View>
        </ScrollView>
...
const styles = StyleSheet.create({
  ...
  appName: { fontSize: 32, fontFamily: "Inter_700Bold", color: "#FFFFFF", marginBottom: 6 },
  tagline: { fontSize: 16, fontFamily: "Inter_400Regular", color: "rgba(255,255,255,0.6)" },
  card: {
    width: "100%",
    borderRadius: 20,
    borderWidth: 1,
  ...
  field: { gap: 6 },
  label: { color: "rgba(255,255,255,0.7)", fontSize: 13, fontFamily: "Inter_500Medium" },
  inputWrap: {
    flexDirection: "row",
    alignItems: "center",
    borderWidth: 1,
  ...
  input: { flex: 1, color: "#FFFFFF", fontSize: 15, fontFamily: "Inter_400Regular" },
  primaryBtn: {
  ...
  footerLink: { color: "#60A5FA", fontSize: 14, fontFamily: "Inter_600SemiBold" },
});
